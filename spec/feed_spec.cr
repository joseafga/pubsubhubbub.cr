...
describe PubSubHubbub::Feed do
  ...
  it "parse entries of a feed notification" do
    feed = PubSubHubbub::Feed.parse(xml)
  ...
  it "parse only topic of a feed notification" do
    PubSubHubbub::Feed.parse_topic(xml).should eq "https://www.youtube.com/xml/feeds/videos.xml?channel_id=SomeChannelId"
  end
end
